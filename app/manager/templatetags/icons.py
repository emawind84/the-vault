...
# Minimal Feather-style line icon set (24x24 viewbox, stroke=currentColor).
# Keeping icons inline (no external icon font/CDN) keeps the app self-contained.
ICONS = {
    ...
    "eye-off": '<path d="M17.94 17.94A10.94 10.94 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 4.06-5.94M9.9 4.24A10.94 10.94 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path><line x1="1" y1="1" x2="23" y2="23"></line>',
    ...
    "trash": '<polyline points="3 6 5 6 21 6"></polyline><path d="M19 6l-1.5 14.5a2 2 0 0 1-2 1.5H8.5a2 2 0 0 1-2-1.5L5 6"></path><path d="M10 11v6"></path><path d="M14 11v6"></path><path d="M9 6V4a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2"></path>',
...
def icon(name, css_class="icon"):
    body = ICONS.get(name, "")
    return mark_safe(
        '<svg class="{0}" viewBox="0 0 24 24" aria-hidden="true">{1}</svg>'.format(
            css_class, body
        )
    )
